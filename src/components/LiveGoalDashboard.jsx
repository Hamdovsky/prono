      ...
      <div className="matrix-grid">
        <div className="matrix-item">
          ...
          <span
            ...
            style={{ color: getProbabilityColor(factors?.scoreState) }}
          >
        ...
        <div className="matrix-item">
          ...
          <span
            className="factor-value"
            style={{ color: getProbabilityColor(factors?.timeFactor) }}
          >
        ...
        <div className="matrix-item">
          ...
          <span
            className="factor-value"
            style={{ color: getProbabilityColor(factors?.pressureFactor) }}
          >
        ...
        <div className="matrix-item">
          ...
          <span
            className="factor-value"
            style={{ color: getProbabilityColor(factors?.oddsFactor) }}
          >
        ...
        <div className="matrix-item">
          ...
          <span
            className="factor-value"
            style={{ color: getProbabilityColor(factors?.patternMatch) }}
          >
        ...
        <div className="matrix-item">
          ...
          <span
            className="factor-value"
            style={{ color: getProbabilityColor(factors?.redCardFactor) }}
          >
        ...
        <div className="stat-item">
          ...
          <span className="stat-value">
            {liveMatches.length > 0
              ? Math.round(
                  liveMatches.reduce((a, b) => a + (b.confidence || 0), 0) / liveMatches.length
                )
              : 0}
            %
          </span>
        ...
        {liveMatches.length === 0 ? (
          ...
          liveMatches.map((match) => (
            <div
              ...
              onClick={() =>
                setSelectedMatch(selectedMatch?.matchId === match.matchId ? null : match)
              }
            >
                      ...
                      <div className="patterns-list">
                        {match.patternMatched.map((p, i) => (
                          <div key={i} className="pattern-item">
                            ...
                            <span>
                              But dans: {p.goalInNext}min | Succès: {p.successRate}%
                            </span>
                          </div>
                        ))}
                      </div>
