  ...
  getRegistry() {
    return [
...

      {
        ...
        check: async () => {
          try {
            import tr from './therundownService'
...

      {
        ...
        check: async () => {
          try {
            import svc from './oddspapiService'
...

      {
        ...
        check: async () => {
          try {
            import svc from './supabaseService'
            if (!svc.enabled) return { detected: false }
...

      {
        ...
        check: async () => {
          try {
            import svc from './sportmonksService'
            if (!svc.enabled) return { detected: false }
...

      {
        ...
        check: async () => {
          try {
            import svc from './oddsApiIoService'
            if (!svc.enabled) return { detected: false }
