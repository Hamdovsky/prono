  ...
  return (
    <div style={{ padding: '16px 20px', color: '#e2e8f0', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginBottom: '24px' }}>
        {[
          ...
          { label: 'Incorrects', value: data.wrong, color: '#ef4444' },
          {
            label: 'Win Rate',
            value: data.winRate + '%',
            color: data.winRate >= 50 ? '#00ffaa' : '#ef4444',
          },
        ].map((stat) => (
          <div
            key={stat.label}
      ...
      >
        ...
        >
          <span style={{ flex: 2, cursor: 'pointer' }} onClick={() => setSortBy('league')}>
            Ligue
          </span>
          <span
        ...
        {sortedLeagues.map((l, i) => {
          ...
          return (
            ...
            >
              ...
              <span style={{ flex: 1, textAlign: 'center', color: '#00ffaa', fontWeight: 600 }}>
                {l.correct}
              </span>
              <span style={{ flex: 1, textAlign: 'center', color: '#ef4444', fontWeight: 600 }}>
                {l.wrong}
              </span>
              <span
                style={{
              ...
              <div style={{ flex: 3, display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                />
                <span style={{ fontSize: '11px', color: '#475569', minWidth: '30px' }}>
                  {l.total}
                </span>
              </div>
            </div>
