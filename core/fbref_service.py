...
LEAGUE_MAP = {
    ...
    'ukrainian league': 'UKR-Premier League',
    'bulgarian first league': 'BUL-First League',
    'bulgarian league': 'BUL-First League',
    'croatian hnl': 'CRO-HNL',
    'croatian league': 'CRO-HNL',
    'serbian superliga': 'SRB-SuperLiga',
    'serbian league': 'SRB-SuperLiga',
    'hungarian nb i': 'HUN-NB I',
    'hungarian league': 'HUN-NB I',
    'romanian liga i': 'ROU-Liga I',
    'romanian league': 'ROU-Liga I',
    'belarusian premier league': 'BLR-Premier League',
    'belarusian league': 'BLR-Premier League',
    'kazakhstan premier league': 'KAZ-Premier League',
    'kazakh league': 'KAZ-Premier League',
    'albanian superliga': 'ALB-Superliga',
    'albanian league': 'ALB-Superliga',
    'moldovan super liga': 'MDA-Super Liga',
    'moldovan league': 'MDA-Super Liga',
    'azerbaijani premier league': 'AZE-Premier League',
    'azerbaijani league': 'AZE-Premier League',
    'lithuanian a lyga': 'LTU-A Lyga',
    'latvian virsliga': 'LVA-Virsliga',
    'estonian meistriliiga': 'EST-Meistriliiga',
    'finnish veikkausliiga': 'FIN-Veikkausliiga',
    'luxembourg national division': 'LUX-National Division',
    'icelandic league': 'ISL-Urvalsdeild',
    'slovak super liga': 'SVK-Super Liga',
    'slovenian prvaliga': 'SVN-PrvaLiga',
    'bosnian league': 'BIH-Premier League',
    'northern irish league': 'NIR-Premiership',
    'welsh league': 'WAL-Cymru Premier',
    'scottish premiership': 'SCO-Premiership',
    'scottish league': 'SCO-Premiership',
    'turkish super lig': 'TUR-Super Lig',
    'turkish league': 'TUR-Super Lig',
    'greek super league': 'GRE-Super League',
    'greek league': 'GRE-Super League',
    ...
    'russian premier league': 'RUS-Premier League',
}

TEAM_MAP = {
    # Extra European teams for Promosport ECL qualifiers
