...
async function testRefinedV50() {
  ...
  try {
    ...
    console.log(
      'Detailed Analysis 7_Context:',
      enriched.enriched.detailed_analysis?.['7_Context']?.reason
    )
    console.log(
      'Detailed Analysis 1_Form:',
      enriched.enriched.detailed_analysis?.['1_Form']?.reason
    )
    console.log(
      'Detailed Analysis 9_Metrics:',
      enriched.enriched.detailed_analysis?.['9_Metrics']?.reason
    )
