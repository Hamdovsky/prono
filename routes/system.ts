...
import shieldEngine from '../core/shieldEngine'
...
router.get('/confluence/report', async (req, res) => {
  try {
    import guard from '../core/confluenceGuardV2'
    await guard.load()
...
router.get('/odds-movement/:matchId', (req, res) => {
  try {
    import analyzer from '../services/oddsMovementAnalyzer'
...
router.get('/scraped-odds', async (req, res) => {
  try {
    import scrapedOdds from '../services/scrapedOddsService'
