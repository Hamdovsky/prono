...
import sharedConfig from '../core/sharedConfig'
...
class DataFusionService {
  ...
  async _tryTherundown(match) {
    import trService from './therundownService'
  ...
  async _tryOddspapi(match) {
    import opService from './oddspapiService'
  ...
  async _trySportmonks(match) {
    import smService from './sportmonksService'
