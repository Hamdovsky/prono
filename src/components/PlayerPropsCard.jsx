...
const PlayerPropsCard = ({ matchId }) => {
  ...
  if (loading)
    return (
      <div style={{ color: '#95a5a6', fontSize: '0.85rem', padding: '10px 0' }}>
        Loading Player Props AI...
      </div>
    )
  ...
  if (props.length === 0 && hasLoaded) {
    return (
      <div style={{ color: '#95a5a6', fontSize: '0.85rem', padding: '10px 0' }}>
        No high-value elite player props detected for this match.
      </div>
    )
  }
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
        {topProps.map((p, index) => {
          ...
          return (
            ...
            >
              <div>
                <div style={{ fontWeight: 'bold', color: '#f1c40f', marginBottom: '4px' }}>
                  {p.player_name}
                </div>
                <div
                  style={{
      ...
      {props.length > 3 && (
        <div
          style={{ textAlign: 'center', marginTop: '10px', fontSize: '0.8rem', color: '#95a5a6' }}
        >
