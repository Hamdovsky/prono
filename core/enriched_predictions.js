...
class EnrichedPredictionService {
    ...
    _isLowData(m) {
        ...
        if (league.includes('friendly') || league.includes('cup') || league.includes('supercup') || league.includes('super_cup') || league.includes('charity') || league.includes('club friendly') || league.includes('friendlies')) return true
