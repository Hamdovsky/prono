...
describe('Scraper API Routes', () => {
  ...
  describe('POST /api/booking-codes/add', () => {
    it('should add a new booking code', async () => {
      ...
      const response = await request(app).post('/api/booking-codes/add').send(newCode)
    ...
    it('should reject duplicate codes for same platform', async () => {
      ...
      const response = await request(app).post('/api/booking-codes/add').send(duplicateCode)
    ...
    it('should require code field', async () => {
      const response = await request(app).post('/api/booking-codes/add').send({ platform: 'Test' })
  ...
  describe('PATCH /api/booking-codes/:id', () => {
    it('should update booking code fields', async () => {
      const mockDb = {
        codes: [{ id: 'update-me', code: 'OLD', platform: 'Betclic', status: 'active' }],
      }
