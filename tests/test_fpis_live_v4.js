...
assert(
  s2.adjusted_prediction.includes('The New Saints Win / Over 2.5 Goals'),
  `Prediction pivoted to leading team ('The New Saints Win / Over 2.5 Goals')`
)
...
assert(
  s3.adjustment_note.includes('[IMMEDIATE RECALC]'),
  `Adjustment note includes [IMMEDIATE RECALC] indicating bypass`
)
