...
const StrategicSections = ({ matches }) => {
  const vaultMatches = matches.filter((m) => {
    const audit =
      typeof m.integrity_audit === 'string'
        ? JSON.parse(m.integrity_audit)
        : m.integrity_audit || {}
              ...
              return (
                <div key={m.id} className="strat-item">
                  <div className="strat-match-info">
                    <span className="strat-teams">
                      {m.homeTeam} vs {m.awayTeam}
                    </span>
                    <span className="strat-reason">
                      {m.prediction_logic || 'AI Precision + News Hit'}
                    </span>
                  </div>
                ...
                <div className="vault-combo-card">
                  <div className="combo-left">
                    ...
                    <span className="combo-desc">
                      {vaultMatches.length} Matches Mixed Accumulator
                    </span>
                  </div>
              ...
              return (
                <div key={m.id} className="strat-item">
                  <div className="strat-match-info">
                    ...
                    <span className="strat-reason">
                      {m.prediction_logic || 'Inside Edge: Mispriced Underdog'}
                    </span>
                  </div>
                  <div className="strat-metrics">
                    <div className="strat-metric">
