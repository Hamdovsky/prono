    ...
    <div className="backtest-container" dir="rtl">
      <header className="backtest-header">
        <div className="bt-title">
          <h1>
            محاكي الاختبار التاريخي (Backtest) <span>Alpha V41</span>
          </h1>
      ...
      {loading && (
        <div className="bt-loading">
          جاري تحليل البيانات ومقارنة التوقعات بالنتائج الفعلية... ⏳
        </div>
      )}
      ...
      {results && !results.error && (
        <div className="bt-grid">
          ...
          <div className="bt-card roi">
            ...
            <span className="bt-v">
              {results.summary.roi > 0 ? '+' : ''}
              {results.summary.roi} وحدة
            </span>
          ...
          <div className="bt-card full-width rating-section">
            ...
            <div className="grade-bar">
              <div
                ...
                style={{ width: `${results.summary.eliteAccuracy}%` }}
              ></div>
            </div>
            <p>
              بناءً على {results.summary.totalMatches} مباراة سابقة، النظام يحصل على تقييم{' '}
              <strong>{results.summary.rating}/10</strong> من حيث الكفاءة التاريخية.
            </p>
          </div>
        </div>
      )}
