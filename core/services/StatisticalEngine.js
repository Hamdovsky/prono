...
class StatisticalEngine {
        ...
        if (rxgH > 0.1 && rxgA > 0.1 && !xgSeemsStale) {
            ...
            if (ts && typeof ts === 'object' && hasRealTeamStats) {
                ...
                if (m.odds_home && m.odds_away && hScored === 0 && aScored === 0) {
                    ...
                    if (derived) { xgH = derived.h; xgA = derived.a; }
                }
                if (!xgH) {
                ...
                if (hStr.matchCount >= 1 || aStr.matchCount >= 1) {
                    ...
                    if (!xgH) {
                        ...
                        if (league.includes('iceland') || league.includes('reykjavik') || league.includes('women') || league.includes('club friendly') || league.includes('friendly')) { baseXgH = 2.0; baseXgA = 1.6; }
                        else if (league.includes('bundesliga') || league.includes('netherlands') || league.includes('eredivisie') || league.includes('austria') || league.includes('swiss') || league.includes('belgium') || league.includes('portugal')) { baseXgH = 1.8; baseXgA = 1.4; }
                        else if (league.includes('premier league') || league.includes('championship') || league.includes('mls') || league.includes('norway') || league.includes('sweden') || league.includes('scotland')) { baseXgH = 1.55; baseXgA = 1.25; }
                        else if (league.includes('serie a') || league.includes('ligue 1') || league.includes('ligue 2') || league.includes('argentina') || league.includes('brazil') || league.includes('superliga') || league.includes('super lig')) { baseXgH = 1.35; baseXgA = 1.1; }
                        else if (league.includes('misli') || league.includes('azerbaijan') || league.includes('ekstraklasa') || league.includes('usl') || league.includes('japan') || league.includes('korea') || league.includes('china')) { baseXgH = 1.7; baseXgA = 1.1; }
                        xgH = baseXgH;
                        xgA = baseXgA;
                    }
                }
    ...
    _getLeagueBaseXG(league) {
        ...
        if (key.includes('bundesliga') || key.includes('netherlands') || key.includes('eredivisie') || key.includes('austria') || key.includes('swiss') || key.includes('belgium') || key.includes('portugal')) return { h: 1.85, a: 1.55 }
        if (key.includes('premier league') || key.includes('championship') || key.includes('norway') || key.includes('sweden') || key.includes('scotland') || key.includes('mls')) return { h: 1.45, a: 1.25 }
        if (key.includes('misli') || key.includes('azerbaijan') || key.includes('ekstraklasa') || key.includes('usl') || key.includes('japan') || key.includes('korea') || key.includes('china')) return { h: 1.7, a: 1.1 }
        if (key.includes('serie a') || key.includes('ligue 2') || key.includes('argentina') || key.includes('brazil') || key.includes('superliga') || key.includes('super lig')) return { h: 1.3, a: 1.1 }
