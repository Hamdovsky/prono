...
import {
  generateAutoSystem,
  generateReduced7Doubles,
  selectBestDoubles,
} from '../utils/promosportUtils'
...
const Promosport = () => {
  ...
  const renderBox = (pred, val) => {
    ...
    return (
      <div className={`promo-box ${isSelected ? 'selected' : ''}`}>{isSelected ? val : ''}</div>
    )
  }
      ...
      {viewMode === 'accuracy' ? (
        ...
        <div className="promosport-weapons" style={{ padding: '20px' }}>
          ...
          >
            ...
            >
              Algorithme basé sur l'analyse de 2452 matchs Tunisiens. Règle: 1 ≥ 55% → pick 1
              (69.2%). 2 ≥ 60% → pick 2 (67.9%). Les matchs sans favori clair sont ignorés (bruit).
            </p>
          </div>
        </div>
        ...
        <div className="promosport-weapons" style={{ padding: '20px' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '15px', marginBottom: '25px', flexWrap: 'wrap' }}>
              ...
              >
                <span style={{ color: '#a78bfa', fontWeight: 'bold', fontSize: '1.3rem' }}>
                  {reducedSystem.sortedColumns?.[0]?.score.toFixed(1) ||
                    reducedSystem.expectedCorrect}
                  /13
                </span>
                      ...
                      >
                        ...
                        <div
                          style={{
                            fontSize: '0.6rem',
                            color:
                              col.score >= 11 ? '#34d399' : col.score >= 9 ? '#fbbf24' : '#f87171',
                            fontWeight: '900',
                            marginTop: '2px',
                          }}
                        >
                          ...
                          return (
                            <td
                              ...
                              style={{
                                ...
                                textAlign: 'center',
                                background:
                                  ci % 2 === 0 ? 'rgba(16, 185, 129, 0.03)' : 'transparent',
                              }}
                            >
                              <span
                                className={pickClass}
        ...
        <div style={{ padding: '16px' }}>
          ...
          >
            ...
            <p style={{ color: '#94a3b8', fontSize: '0.75rem', marginBottom: '16px' }}>
              ...
              doubles = {Math.pow(2, goldCoupon.stats?.totalDoubles || 6)} colonnes · Backtest:
              56.97% précision
            </p>
            <div
              style={{
                      ...
                      {['1', 'X', '2'].map((v) => (
                        <span
                          ...
                          style={{
                            ...
                            fontSize: '0.6rem',
                            fontWeight: '700',
                            background: m.choices?.includes(v)
                              ? '#fbbf24'
        ...
        <>
          ...
          >
            ...
            >
              <span style={{ fontSize: '2rem' }}>🎫</span> TICKET UNIQUE (8 MATCHS PREMIUM) —
              ANALYSE TITANIUM
            </h3>
            <div
              style={{
            ...
            >
              ⚠️ Sélection automatique des 8 meilleurs matchs basée sur l'indice de confiance
              Titanium (P differential {'>'} 45%).
            </div>
            ...
            <div style={{ overflowX: 'auto', maxWidth: '100%' }}>
              ...
              >
                <thead>
                  ...
                  >
                    <th style={{ padding: '8px 6px', textAlign: 'center', minWidth: '40px' }}>
                      N°
                    </th>
            ...
            >
              ...
              >
                ...
                <p style={{ color: '#94a3b8', fontSize: '0.85rem' }}>
                  Sélectionne les matchs où le modèle a le plus d'avance sur la foule (edge {'>'}{' '}
                  5pts). Maximise la valeur réelle en jouant les picks où l'IA voit mieux que le
                  public.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p style={{ color: '#94a3b8', fontSize: '0.85rem' }}>
                  Priorise les favoris avec des indices de confiance Titanium {'>'} 85% (Al Nassr,
                  Aston Villa). Utilise les doubles pour verrouiller les résultats nuls probables en
                  Ligue 1 Tunisienne.
                </p>
              </div>
            </div>
