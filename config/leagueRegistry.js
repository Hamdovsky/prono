...
const LEAGUES = [
  ...
  },
  {
    ...
    flag: '🇧🇷',
    tier: 'TIER1',
    sofascoreSlug: 'brasileirao-serie-a',
    syncPriority: 'HIGH',
    webhookEnabled: true,
    smartScanEnabled: true,
  },
  ...
  // ── PREMIUM ARAB (Bet365 / 1xBet covered) ───
  {
    ...
    flag: '🇸🇦',
    tier: 'TIER1',
    sofascoreSlug: 'saudi-pro-league',
    sofascoreId: 955,
    syncPriority: 'HIGH',
    forceSync: true,
    webhookEnabled: true,
  ...
  },
  {
    id: 'KUW_PL',
    name: 'Kuwait League',
    displayName: 'Kuwaiti Premier League',
    country: 'kuwait',
    countryCode: 'KUW',
    flag: '🇰🇼',
    tier: 'TIER2',
    sofascoreSlug: 'kuwait-league',
    sofascoreId: 980,
    syncPriority: 'MEDIUM',
    forceSync: true,
    arabicNewsEnabled: true,
  },
  {
    ...
    displayName: 'Iraq Stars League',
    country: 'iraq',
    countryCode: 'IRQ',
    flag: '🇮🇶',
    tier: 'TIER2',
    sofascoreSlug: 'iraq-stars-league',
    sofascoreId: 11261,
    syncPriority: 'MEDIUM',
    forceSync: true,
    arabicNewsEnabled: true,
  },
  {
    ...
    displayName: 'Jordan Pro League',
    country: 'jordan',
    countryCode: 'JOR',
    flag: '🇯🇴',
    tier: 'TIER2',
    sofascoreSlug: 'jordan-pro-league',
    sofascoreId: 410,
    syncPriority: 'MEDIUM',
    forceSync: true,
    arabicNewsEnabled: true,
  },
  {
    ...
    displayName: 'Oman Professional League',
    country: 'oman',
    countryCode: 'OMA',
    flag: '🇴🇲',
    tier: 'TIER2',
    sofascoreSlug: 'oman-professional-league',
    sofascoreId: 3043,
    syncPriority: 'MEDIUM',
    forceSync: true,
    arabicNewsEnabled: true,
  },
  {
    ...
    displayName: 'Libyan Premier League',
    country: 'libya',
    countryCode: 'LBY',
    flag: '🇱🇾',
    tier: 'TIER2',
    sofascoreSlug: 'libyan-premier-league',
    sofascoreId: 3047,
    syncPriority: 'MEDIUM',
    forceSync: true,
    arabicNewsEnabled: true,
  },
  {
    ...
    displayName: 'Lebanese Premier League',
    country: 'lebanon',
    countryCode: 'LBN',
    flag: '🇱🇧',
    tier: 'TIER2',
    sofascoreSlug: 'lebanese-premier-league',
    sofascoreId: 3831,
    syncPriority: 'MEDIUM',
    forceSync: true,
    arabicNewsEnabled: true,
  ...
  {
    id: 'SYR_PL',
    name: 'Syrian Premier League',
    displayName: 'Syrian Premier League',
    country: 'syria',
    countryCode: 'SYR',
    flag: '🇸🇾',
    tier: 'TIER2',
    sofascoreSlug: 'syrian-premier-league',
    sofascoreId: 1243,
    syncPriority: 'MEDIUM',
    forceSync: true,
    arabicNewsEnabled: true,
  },
  {
    ...
    displayName: 'Bahraini Premier League',
    country: 'bahrain',
    countryCode: 'BHR',
    flag: '🇧🇭',
    tier: 'TIER2',
    sofascoreSlug: 'bahraini-premier-league',
    sofascoreId: 846,
    syncPriority: 'MEDIUM',
    forceSync: true,
    arabicNewsEnabled: true,
  },
  {
    ...
    flag: '🇿🇦',
    tier: 'TIER2',
    sofascoreSlug: 'premier-soccer-league',
    syncPriority: 'MEDIUM',
  },
  {
    id: 'ENG_PL2',
    name: 'Premier League 2, Division 1',
    displayName: 'Premier League 2',
    country: 'england',
    countryCode: 'ENG',
    flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿',
    tier: 'TIER2',
    sofascoreSlug: 'premier-league-2-division-1',
    sofascoreId: 1129,
    syncPriority: 'MEDIUM',
    forceSync: true,
  },
