...
const pool = new Pool({
  connectionString: 'postgresql://neondb_owner:npg_sYcm9EnGq8fu@ep-green-firefly-ap7belpw-pooler.c-7.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require',
  max: 5,
})
