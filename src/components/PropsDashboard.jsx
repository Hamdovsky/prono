    ...
    <div className="props-dashboard">
      <header className="props-header">
        ...
        <p className="props-subtitle">
          Paris de Valeur par l'IA sur les Performances Individuelles
        </p>
      </header>
                ...
                <div className="prop-body">
                  ...
                  <div className="prop-details">
                    ...
                    <div className="detail-row">
                      ...
                      {isElite ? (
                        <span className="detail-value ev-high">Élevée 🔥</span>
                      ) : (
                        <span className="detail-value ev-med">Moyenne</span>
                      )}
                    </div>
                  </div>
                </div>
